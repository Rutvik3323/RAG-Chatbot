...
class RAGEvaluator:
    def __init__(self, threshold=0.7):
        ...
        sundar = genai.Client(api_key=os.getenv("GEMINI_API_KEY"))
        self.model = sundar.models.generate_content(model="gemini-1.5-pro", contents="") # Need to pass contents parameter if get an error
